...
class Disc_test(MyTestCase):
    ...
    def test_add_to_body(self):
        ...
        self.assertAlmostEquals(disc.shape.friction, Material.gold.friction,
            msg="bad friction")
        self.assertAlmostEquals(disc.shape.elasticity, Material.gold.elasticity,
            msg="bad elasticity")
